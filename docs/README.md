...
| [09-pendiente-horizonte-vencimiento.md](09-pendiente-horizonte-vencimiento.md) | **Pendiente de investigar.** Cómo debería comportarse la simulación cuando el vencimiento de un bono/letra cae después del horizonte del portfolio — no debe ser una validación bloqueante, sino un tope en la estimación. |
